  ...
  return (
    ...
    <div className='w-full h-full'>
      ...
      <div className="blurb text-left py-8">
        <h1 className="text-2xl font-bold py-3 px-7 bg-[#f4a10c] text-white rounded-3xl">University Rankings and Top Jobs</h1>
        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 p-7">
            ...
            <ul>
              ...
              <li className='text-[#003463] font-bold' ><Link to="/employer/queensland-university-of-technology/3786/">Queensland
