...
export const countryMappings1 = {
    ...
    Asia: { menu: 'Asia', searchLocation: 'Singapore', hasPic: false },
    ...
    'UK': { menu: 'United Kingdom', searchLocation: 'UK', hasPic: true },
    'USA': { menu: 'USA', searchLocation: 'USA', searchLocation1: 'USA', hasPic: true },
};